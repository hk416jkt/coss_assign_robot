...
public:
...

    {
        ...
        cmd_pub_ = this->create_publisher<square_interfaces::msg::Cmd>("/cmd", loop_rate_);
...
private:
    void main_loop()
    {
        ...
        // if ((!button_joy_) && (!button_movebase_) && (!keyboard_))
        {
            ...
            {
                auto cmd_msg = square_interfaces::msg::Cmd();
...
private:
    rclcpp::Publisher<square_interfaces::msg::Cmd>::SharedPtr cmd_pub_;
