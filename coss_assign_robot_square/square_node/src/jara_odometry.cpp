...
public:
                     ...
                     prev_r_ecd_(0)
    {
        ...
        this->declare_parameter("wheel_base", 0.190 ); // if using circle : 220
        ...
        ecd_sub_ = create_subscription<square_interfaces::msg::Ecd>(
            "/ecd", 20, std::bind(&JaraOdometry::ecd_callback, this, _1));
    }

private:
    void ecd_callback(const square_interfaces::msg::Ecd::SharedPtr msg)
    {
...
private:
    ...
    rclcpp::Subscription<square_interfaces::msg::Ecd>::SharedPtr ecd_sub_;
