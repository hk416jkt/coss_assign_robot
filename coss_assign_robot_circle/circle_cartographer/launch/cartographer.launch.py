...
def generate_launch_description():
    ...
    jarabot_cartographer_prefix = get_package_share_directory('circle_cartographer')
    ...
    rviz_config_dir = os.path.join(get_package_share_directory('circle_cartographer'),
                                   'rviz', 'circle_cartographer.rviz')
