...
public:
                     ...
                     prev_r_ecd_(0)
    {
        ...
        this->declare_parameter("wheel_base", 0.220); // if using square : 0.190 
        ...
        ecd_sub_ = create_subscription<circle_interfaces::msg::Ecd>(
            "/ecd", 20, std::bind(&JaraOdometry::ecd_callback, this, _1));
    }

private:
    void ecd_callback(const circle_interfaces::msg::Ecd::SharedPtr msg)
    {
...
private:
    ...
    rclcpp::Subscription<circle_interfaces::msg::Ecd>::SharedPtr ecd_sub_;
