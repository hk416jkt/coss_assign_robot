...
public:
...

    {
        ...
        cmd_pub_ = this->create_publisher<circle_interfaces::msg::Cmd>("/cmd", loop_rate_);
...
private:
    void main_loop()
    {
        ...
        // if ((!button_joy_) && (!button_movebase_) && (!keyboard_))
        {
            ...
            {
                auto cmd_msg = circle_interfaces::msg::Cmd();
...
private:
    rclcpp::Publisher<circle_interfaces::msg::Cmd>::SharedPtr cmd_pub_;
